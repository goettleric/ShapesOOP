...
public class CuboidTest {
	...
	public void testSurfaceArea(float x, float y, float z) {
		//1. Arrange
		Cuboid cuboid = new Cuboid(messageBox, x, y, z);
	...
	public void testCuboid(float x, float y, float z) {
		//1. Arrange
		Cuboid expected = new Cuboid(messageBox, x,y,z);
		//2. Act
		Cuboid actual = new Cuboid(messageBox, expected.getWidth(), expected.getHeight(), expected.getDepth());
		//3. Assert
